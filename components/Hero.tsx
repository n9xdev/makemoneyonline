  ...
  return (
    <section className={styles.heroSection} id="hero">
      ...
      <div className={styles.heroContent}>
        <h1 className={styles.heroTitle}>$150k+ Profit Trader, Researcher & Developer</h1>
        <h2 className={styles.heroSubtitle}>AI Agents, GameFi, Provably Fair Casinos</h2>
        ...
        <div className={styles.socialSection}>
          ...
          <div className={styles.socialIcons}>
            <a href="https://x.com/intent/follow?screen_name=xxniiinxx" target="_blank" rel="noopener noreferrer" className={styles.socialIcon} aria-label="X (Twitter)">
            ...
            <a href="https://t.me/bosonax" target="_blank" rel="noopener noreferrer" className={styles.socialIcon} aria-label="Telegram">
              <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
            ...
            <a href="https://youtube.com/@bosonax" target="_blank" rel="noopener noreferrer" className={styles.socialIcon} aria-label="YouTube">
              <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
            ...
            <a href="https://github.com/n9xdev" target="_blank" rel="noopener noreferrer" className={styles.socialIcon} aria-label="GitHub">
              <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
